...
contract Raffle is VRFConsumerBaseV2 {
    ...
    /**
     * @dev This function is called by the Chainlink Automation to see if its time for an upkeep
     * The following should be true for this function to return true:
     * 1. The time interval has passed
     * 2. The raffle is in the OPEN state
     * 3. There are players in the raffle aka the contract has eth
